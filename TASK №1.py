...
# Напишите функцию draw_board(board), которая рисует доску размером 3х3.
# Функция принимает на вход двумерный список и выдает игровое поле.
board = [" ", " ", " "]
...
def ask_and_make_move(player, board):
    ...
    x, y = int(x), int(y)  # преобразовать координаты в целые числа
